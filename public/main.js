...
var routes = [
    { path: '', component: _postlist_postlist_component__WEBPACK_IMPORTED_MODULE_3__["PostlistComponent"] },
    { path: 'post/:_id', component: _postlist_postlist_component__WEBPACK_IMPORTED_MODULE_3__["PostlistComponent"] },
    { path: 'posts', component: _postlist_postlist_component__WEBPACK_IMPORTED_MODULE_3__["PostlistComponent"] }
];
...
var AppSettings = /** @class */ (function () {
    ...
    AppSettings.apiUrl = "http://127.0.0.1:8888/";
    return AppSettings;
}());
...
/* harmony import */ var _postlist_postlist_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./postlist/postlist.component */ "./src/app/postlist/postlist.component.ts");
/* harmony import */ var _postlist_post_post_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./postlist/post/post.component */ "./src/app/postlist/post/post.component.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _postlist_post_commentlist_commentlist_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./postlist/post/commentlist/commentlist.component */ "./src/app/postlist/post/commentlist/commentlist.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _postlist_postlist_component__WEBPACK_IMPORTED_MODULE_7__["PostlistComponent"],
                _postlist_post_post_component__WEBPACK_IMPORTED_MODULE_8__["PostComponent"],
                _postlist_post_commentlist_commentlist_component__WEBPACK_IMPORTED_MODULE_10__["CommentlistComponent"]
            ],
            imports: [
...
var AuthService = /** @class */ (function () {
    function AuthService(httpClient, alerts, router) {
    ...
    AuthService.prototype.login = function (username, password) {
        ...
        return new Promise(function (resolve, reject) {
            _this.httpClient.post(_this.baseURL + 'login', {
                username: username,
                password: password
            }).subscribe(function (resp) {
                _this.alerts.setMessage('login successful', 'success');
                ...
                resolve(_this.httpOptions);
                _this.router.navigateByUrl(_this.router.url);
            }, function (error) {
                _this.alerts.setMessage((error.error.error), 'error');
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], angular_alert_module__WEBPACK_IMPORTED_MODULE_3__["AlertsService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
    ], AuthService);
    return AuthService;
}());
...
var PostService = /** @class */ (function () {
    function PostService(httpClient, authService) {
        this.httpClient = httpClient;
        this.authService = authService;
        this.posts = [];
        this.baseURL = _app_settings__WEBPACK_IMPORTED_MODULE_3__["AppSettings"].apiUrl;
        this.postPath = 'post';
        this.post = null;
    }
    ...
    PostService.prototype.getPost = function (id) {
        var p = this.httpClient.get(this.baseURL + this.postPath + '/' + id, this.authService.httpOptions);
        return p;
    };
    PostService.prototype.editPost = function (post) {
        var res = this.httpClient.put(this.baseURL + this.postPath + '/' + post._id, post, this.authService.httpOptions);
        return res;
    };
...
/***/ "./src/app/postcomment.service.ts":
/*!****************************************!*\
  !*** ./src/app/postcomment.service.ts ***!
  \****************************************/
/*! exports provided: PostCommentService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PostCommentService", function() { return PostCommentService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _app_settings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app-settings */ "./src/app/app-settings.ts");
...
var PostCommentService = /** @class */ (function () {
    function PostCommentService(httpClient, authService) {
        this.httpClient = httpClient;
        this.authService = authService;
        this.postComments = [];
        this.baseURL = _app_settings__WEBPACK_IMPORTED_MODULE_3__["AppSettings"].apiUrl;
    ...
    PostCommentService.prototype.ngOnInit = function () {
    };
    PostCommentService.prototype.getPostCommentsByPostId = function (postId) {
        return this.httpClient.get(this.baseURL + this.postPath + '/' + postId + '/' + 'comment', this.authService.httpOptions);
    };
    PostCommentService.prototype.deleteComment = function (commentId) {
        return this.httpClient.delete(this.baseURL + this.commentPath + '/' + commentId, this.authService.httpOptions);
    };
    PostCommentService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _auth_service__WEBPACK_IMPORTED_MODULE_4__["AuthService"]])
...
/***/ "./src/app/postlist/post/commentlist/commentlist.component.html":
/*!**********************************************************************!*\
  !*** ./src/app/postlist/post/commentlist/commentlist.component.html ***!
  \**********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/postlist/post/commentlist/commentlist.component.ts":
/*!********************************************************************!*\
  !*** ./src/app/postlist/post/commentlist/commentlist.component.ts ***!
  \********************************************************************/
...
var CommentlistComponent = /** @class */ (function () {
    ...
    CommentlistComponent.prototype.ngOnInit = function () {
        ...
        this.postCommentService.getPostCommentsByPostId(id).subscribe(function (postComments) {
            _this.postComments = postComments;
        });
    };
    CommentlistComponent.prototype.deleteComment = function (commentId) {
        var _this = this;
        this.postCommentService.deleteComment(commentId).subscribe(function (res) {
            _this.ngOnInit();
        });
    };
...
/***/ "./src/app/postlist/post/post.component.html":
/*!***************************************************!*\
  !*** ./src/app/postlist/post/post.component.html ***!
  \***************************************************/
/*! no static exports found */
...
/***/ "./src/app/postlist/post/post.component.ts":
/*!*************************************************!*\
  !*** ./src/app/postlist/post/post.component.ts ***!
  \*************************************************/
...
var PostComponent = /** @class */ (function () {
    ...
    PostComponent.prototype.ngOnInit = function () {
        ...
        this.postService.getPost(this.id).subscribe(function (res) {
            _this.post = res;
    ...
    function PostlistComponent(postService, router, authService) {
        ...
        this.router.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_3__["NavigationEnd"]) {
                ...
                _this.ngOnInit();
                if (event.url.match(/\/post\/[a-zA-Z0-9]+/)) {
                    _this.isPostSelected = /\/post\/([a-zA-Z0-9]+)/.exec(event.url)[1];
                }
            }
        });
    }
...
module.exports = __webpack_require__(/*! /mnt/d/code/HackMEAN/hackmean-client/src/main.ts */"./src/main.ts");
